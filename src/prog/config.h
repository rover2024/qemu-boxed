...
#define FFMPEG_CONFIGURATION "--disable-decoders --enable-decoder='aac*,adpcm*,alac,als,anull,ape,atrac*,eac3,flac,gsm*,mp1*,mp2*,mp3*,mpc*,opus,ra*,ralf,shorten,tak,tta,vorbis,wavpack,wma*,pcm*,dsd*,truehd,mjpeg' --disable-encoders --enable-encoder='aac*,adpcm*,alac,anull,eac3,flac,mp3*,opus,ra*,tta,vorbis,wavpack,wma*,pcm*,truehd' --enable-rpath --enable-pic --enable-shared --disable-doc --enable-runtime-cpudetect --prefix=ffbuild/release --disable-debug --enable-optimizations --enable-stripping --enable-asm --enable-x86asm --arch=x86_64"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "ffbuild/release/share/ffmpeg"
#define AVCONV_DATADIR "ffbuild/release/share/ffmpeg"
